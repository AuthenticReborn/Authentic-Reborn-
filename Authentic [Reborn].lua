...
client.color_log(lua_color[1], lua_color[2], lua_color[3], " Authentic\0")
client.color_log(255, 255, 255, " [Reborn]")

local tab, container_aa, container_fl = "AA", "Anti-aimbot angles", "Fake lag"
local label = ui.new_label(tab, container_aa, "Authentic")
...
config_system = {
    ...
    create_db = function()
        ...
        http.get("https://raw.githubusercontent.com/AuthenticReborn/Authentic-Reborn-/main/antiaim_preset", function(success, response)
            if not success then
...
client.set_event_callback("paint_ui", function()
    ...
    name_color_array = lua.funcs.create_color_array(lua_color[1], lua_color[2], lua_color[3], "Authentic [Reborn]")
